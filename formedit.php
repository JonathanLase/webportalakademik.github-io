...
<body style="background-color:#e9ecef">
    ...
    <form method="POST" action="edit.php">
        ...
        <h2 style="text-align:center;color:solid black; font-size:30px;" class="mt-3" >EDIT DATA</h2>
        <hr class="my-4">
        <table style="position:relative; left:27%">
            <tr>
                <td><b style="position: relative;left:-40%;"  >NIM</b></td>
                <td><input class="mb-2" style="position: relative;left:10%; width:210px" type="text" value="<?php echo $uas['nim']; ?>" name="nim"></td>
            </tr>
            <tr>
                <td><b style="position: relative;left:-40%;">NAMA</b></td>
                <td><input class="mb-2" style="position: relative;left:10%; width:210px;" type="text" value="<?php echo $uas['nama']; ?>" name="nama"></td>
            </tr>
            <tr>
                <td><b style="position: relative;left:-40%;">ALAMAT</b></td>
                <td><input class="mb-2" style="position: relative;left:10%; width:210px" value="<?php echo $uas['alamat']; ?>" type="text" name="alamat"></td>
            </tr>
            <tr>
                <td><b style="position: relative;left:-40%;">JENIS KELAMIN</b></td>
                <td style="position: relative;left:6%;">
                    <input type="radio" name="jenis_kelamin" value="L" <?php echo active_radio_button("L", $uas['jenis_kelamin']) ?>><b class="mr-2">Laki-laki</b>
                    <input type="radio" name="jenis_kelamin" value="P" <?php echo active_radio_button("P", $uas['jenis_kelamin']) ?>><b>Perempuan</b>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select class="mt-2" style="position: relative;left:10%; width:210px" name="prodi" id="">
                        ...
                        foreach ($prodi as $j) {
                            echo "<option value = '$j'";
                            echo $uas['prodi'] == $j ? 'selected="selected"' : '';
                            echo ">$j</option>";
                        }
                        ?>
                    </select>
            ...
            <tr>
                <td colspan="2">
                <button      type="submit" value="save" class="mt-4 mb-4    mr-3 btn btn-primary" style="position: relative;left:43%;">SIMPAN PERUBAHAN</button>
                <a href="datamahasiswa.php"><button class="btn btn-primary" style="position: relative;left:43%;">KEMBALI</button></a></td>
                </tr>
        </table>
        </div>
    </form>
